...
public class Sha256GeneratorTest {
    ...
    private final Sha256Generator sha256Generator;
    ...
    @Test
    @DisplayName("Should encode SHA-256 to byte[]")
    public void shouldEncodeToBytes() throws APIException {
        // given
    ...
    @Test
    @DisplayName("Should encode SHA-256 to Base64")
    public void shouldEncodeToBase64() throws APIException {
        // given
